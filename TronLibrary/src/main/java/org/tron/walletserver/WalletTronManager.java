...
public class WalletTronManager {
...
//        Context context = TronWalletApplication.getAppContext();
    ...
    public static void store(Context context, WalletTron wallet, String password) throws DuplicateNameException, InvalidPasswordException, InvalidNameException {
...
//        FirebaseAnalytics.getInstance(context).logEvent("new_wallet", bundle);
    ...
    public static void storeWatchOnly(Context context, WalletTron wallet) throws InvalidNameException, DuplicateNameException {
    ...
    public static WalletTron getSelectedWallet(Context context) {
    ...
    public static WalletTron getWallet(Context context, String walletName, String password) {
        if (existWallet(context,walletName)) {
            ...
            WalletTron wallet = new WalletTron(privateKey);
    ...
    public static WalletTron getWallet(Context context, String walletName) {
    ...
    public static Contract.VoteWitnessContract createVoteWitnessContract(byte[] owner,
        ...
        for (String addressBase58 : witness.keySet()) {
            ...
            Contract.VoteWitnessContract.Vote.Builder voteBuilder = Contract.VoteWitnessContract.Vote
                    .newBuilder();
            byte[] address = WalletTronManager.decodeFromBase58Check(addressBase58);
            if (address == null) {
                continue;
            }
    ...
    public static boolean checkPassword(WalletTron wallet, String password) {
        byte[] pwd = getPasswordHash(password);
        if (pwd == null) {
            return false;
        }
    ...
    public static boolean isTransactionConfirmed(Transaction transaction) {
        ...
        while ((confirmedTransaction == null || !confirmedTransaction.hasRawData()) && tries <= maxTries) {
            try {
                confirmedTransaction = WalletTronManager.getTransactionById(txID, true);
                tries++;

 ...
 * @创建时间： 2021/12/5
 */
public class ManageWalletAdapter extends BaseQuickAdapter<MyDataBean, BaseViewHolder> {
    private final boolean isNeedDelete;

    public ManageWalletAdapter(List<MyDataBean> datas, boolean isNeedDelete) {

...
public final class QuickItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private QuickItemDecoration(Builder builder) {
    ...
    public static class Builder {
        ...
        private Builder(@NonNull Context context) {
            ...
            if (this.drawable == null) {
                Log.w("QuickItemDecoration", "@android:attr/listDivider was not set");
            }
            a.recycle();
        }

        public QuickItemDecoration build() {
            return new QuickItemDecoration(this);
        }

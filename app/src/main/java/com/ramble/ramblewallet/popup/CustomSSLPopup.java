...
public class CustomSSLPopup extends CenterPopupView {
    ...
    public CustomSSLPopup(@NonNull Context context, String title, String content, String cancelTxt, String okTxt, SslErrorHandler handler) {
        super(context);

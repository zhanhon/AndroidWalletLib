...
import static com.ramble.ramblewallet.pull.QMUIInterpolatorStaticHolder.QUNITIC_INTERPOLATOR;
...
public abstract class QMUIContinuousNestedBottomDelegateLayout extends QMUIFrameLayout implements
    ...
    private final QMUIViewOffsetHelper mHeaderViewOffsetHelper;
    private final QMUIViewOffsetHelper mContentViewOffsetHelper;
    ...
    private final Runnable mCheckLayoutAction = new Runnable() {
        @Override
        public void run() {
            checkLayout();
        }

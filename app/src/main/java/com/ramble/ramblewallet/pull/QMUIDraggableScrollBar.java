...
public class QMUIDraggableScrollBar extends View {
    ...
    private final Runnable mDelayInvalidateRunnable = new Runnable() {
        @Override
        public void run() {
            invalidate();
        }
    ...
    private final int mAdjustDistanceProtection = QMUIDisplayHelper.dp2px(getContext(), 20);
    private final int mAdjustMaxDistanceOnce = QMUIDisplayHelper.dp2px(getContext(), 4);

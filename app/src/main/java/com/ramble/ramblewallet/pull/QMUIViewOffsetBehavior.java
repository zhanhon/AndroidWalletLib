...
public abstract class QMUIViewOffsetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public abstract boolean onMeasureChild(@NonNull CoordinatorLayout parent, @NonNull View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed);
}

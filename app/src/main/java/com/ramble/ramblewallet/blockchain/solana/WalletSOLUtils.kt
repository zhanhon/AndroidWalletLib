...
companion object {
     ...
     * @return
     */
    fun generateWalletByMnemonic(walletname: String, walletPassword: String, mnemonic: String, mnemonicList: List<String>): Wallet {
        return try {
            ...
            Wallet(walletname, walletPassword, mnemonic, account.publicKey.toBase58(), privateKey, null, 4, mnemonicList)
        } catch (e: Exception) {
            e.printStackTrace()
            Wallet("", "", "", "", "", "",  4, null)
        }
     ...
     * @return
     */
    fun generateWalletByPrivateKey(walletname: String, walletPassword: String, privateKey: String, mnemonicList: List<String>): Wallet {
        return try {
